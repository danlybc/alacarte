...
class MapContainer extends Component {
  ...
  /** Check if user want to share his location */
  ...
  /** Change state of Add New Restaurant on click to adapt list position */
  handleFormClick = () => {
    if (this.state.formState) {
      this.setListPosition('default')
      this.setState({ ...INITIAL_LIST_STATE })
    } else {
  ...
  /** Change state of Card on click, to adapt list position and get restaurants reviews*/
  handleCardClick = id => {
  ...
  /** Change state of Add New Review on click, to adapt list position */
  ...
  /** Set filter on click, will hide filtered restaurants markers from Map View and cards from List */
