...
/** Tooltip component used to view restaurants info when hovering a restaurant marker on the map
 * @param {Object} info Object containing restaurants information : name, open (can be 'open','closed','unconfirmed'), ratings (object of reviews)
